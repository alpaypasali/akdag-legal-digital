...
function AboutPage() {
  return (
    <>
      ...
      <section className="surface-stone paper-grain surface-rise relative py-14 md:py-20">
      ...
      <section className="surface-greige paper-grain surface-rise relative py-14 md:py-20">
